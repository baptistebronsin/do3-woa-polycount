...
groupe_router.patch('/', authentification, groupe_controller.modifier_groupe);
groupe_router.delete('/:groupe_id_param/participant', authentification, groupe_controller.quitter_groupe);
groupe_router.delete('/:groupe_id_param', authentification, groupe_controller.cloturer_groupe);
