...
CREATE TABLE "Depense" (
    ...
    "fk_groupe_id" INTEGER NOT NULL,
    "fk_participant_createur_id" INTEGER NOT NULL,
    "titre" VARCHAR(50),
...
-- CreateTable
CREATE TABLE "Participant_Groupe_Liee_Depense" (
    "fk_participant_groupe_id" INTEGER NOT NULL,
    "fk_depense_id" INTEGER NOT NULL,
    "montant" DOUBLE PRECISION,

    CONSTRAINT "Participant_Groupe_Liee_Depense_pkey" PRIMARY KEY ("fk_participant_groupe_id","fk_depense_id")
);
...
-- AddForeignKey
ALTER TABLE "Depense" ADD CONSTRAINT "Depense_fk_participant_createur_id_fkey" FOREIGN KEY ("fk_participant_createur_id") REFERENCES "Participant_Groupe"("pk_participant_groupe_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Participant_Groupe_Liee_Depense" ADD CONSTRAINT "Participant_Groupe_Liee_Depense_fk_participant_groupe_id_fkey" FOREIGN KEY ("fk_participant_groupe_id") REFERENCES "Participant_Groupe"("pk_participant_groupe_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Participant_Groupe_Liee_Depense" ADD CONSTRAINT "Participant_Groupe_Liee_Depense_fk_depense_id_fkey" FOREIGN KEY ("fk_depense_id") REFERENCES "Depense"("pk_depense_id") ON DELETE RESTRICT ON UPDATE CASCADE;
